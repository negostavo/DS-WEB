...
<head>
    ...
    <title>Guerine Hortifruti - Produto</title>
        ...
        <div class="container">
            ...
            <div class="formulario">
                <form action="insertion.php" method="POST" name = "formulario" onsubmit= "return validarProduto()" >
                    <label style="color: white;" for="cod">Código do produto: </label>
                    <input type="number" min="0" step="1" max="99999" name="codigoProduto" id="cod"  placeholder="Codigo do protudo até 5 caracteres" required>
                    <p class="erro-input" id="erro-cod"></p>
                    
                    <label style="color: white;" for="produto">Produto: </label>
                    ...
                    <label style="color: white;" for="estoque">Estoque de produtos</label>
                    <input type="number" name = "estoque" id = "estoque"  placeholder="Digite a quantidade do produto" required> 
                    <p class="erro-input" id="erro-estoque"></p>

                    <label style="color: white;" for="preco">Preço</label>
                    <input type="float" name = "preco" id = "preco"  placeholder="Insira o preço por Kg (Utilize . )" required> 
                    <input type="submit">       
            ...
            echo "<h2 style='color: white;'>Produtos cadastrados:</h2>";
